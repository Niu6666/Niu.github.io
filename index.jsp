        ...
        <div class="top-header">
            ...
            <div class="top-nav">
                <div class="navigation">
                    <div class="logo">
                        <h1><a href="index.html"><span>个人</span>简历</a></h1>
                    </div>
                    <div class="navigation-right">
                        <span class="menu"><img src="images/menu.png" alt=" " /></span>
                        <nav class="link-effect-3" id="link-effect-3">
                            <ul class="nav1 nav nav-wil">
                                <li class="active"><a data-hover="主页" href="index.jsp">主页</a></li>
                                <li><a class="scroll" data-hover="教育背景" href="#about">教育背景</a></li>
                                <li><a class="scroll" data-hover="专业技能" href="#services" >专业技能</a></li>
                                <li><a class="scroll" data-hover="个人荣誉" href="#work">项目经验</a></li>
                                <li><a class="scroll" data-hover="奖项展示" href="#port">荣誉展示</a></li>
                ...
                <div class="col-md-7 header-right">
                    ...
                    <ul class="address">
                        ...
                        <li>
                            <ul class="address-text">
                                <li><b>年龄： </b></li>
                                <li><a href="mailto:example@mail.com"> 21岁</a></li>
                            </ul>
                        </li>
                        <li>
                            <ul class="address-text">
        ...
        <div id="owl-demo1" class="owl-carousel owl-carousel2">
            <div class="item">
                <div class="about-left-grid">
                    <h2>你好！ <span>我叫牛振鹏</span></h2>
                    <p>计算机专业能力方面： 有大数据数据处理的项目经验；熟练使用 idea、pycharm等开发工具 熟练使用主流的关系型数据库，如 mysql ； 熟悉 Hbase 等非关系型数据库的基本使用 。；熟悉 Java 语言，熟练掌握SpringMVC，SpringBoot 框架的基本使用 ，熟练 Javaweb 应用开发；具备计算机系统的理论知识，熟悉基本通信原理。</p>
<%--                    <ul>--%>
...
<%--                    </ul>--%>
            ...
            <div class="item">
                <div class="about-left-grid">
                    <h2><span>主修课程</span></h2>
                    <p>JAVA 语言程序设计、WEB 应用开发技术、算法与数据结构、数据库原理、软件工 程、软件设计、软件构造、软件需求与分析等</p>
                    <h2><span>荣 誉</span></h2>
                    <p>多次个人单项奖学金、二等奖学金、年度优秀青年志愿者、院级优秀学生干部等 河北调研 省级立项 全国大学生英语竞赛 C 组三等奖</p>
                    <h2><span>职 务</span></h2>
                    <p>奖信息学院青年志愿者协会部长、班级心理委员</p>
<%--                    <ul>--%>
<%--                        <li><a class="a-btn-a scroll" href="#port">My Work</a></li>--%>
<%--                        <li><a class="a-btn-h scroll" href="#contact">Hire Me</a></li>--%>
<%--                    </ul>--%>
...
<%--                <div class="about-left-grid">--%>
<%--                    <h2><span>职 务</span></h2>--%>
<%--                    <p>信息学院青年志愿者协会部长、班级心理委员</p>--%>
<%--&lt;%&ndash;                    <ul>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <li><a class="a-btn-a scroll" href="#port">My Work</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <li><a class="a-btn-h scroll" href="#contact">Hire Me</a></li>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </ul>&ndash;%&gt;--%>
<%--                </div>--%>
<%--            </div>--%>
...
<%--            <h4>WHAT I DO</h4>--%>
        ...
        <div class="wthree_about_right_grids w3l-agile">
            ...
            <div class="col-md-6 wthree_about_right_grid">
                ...
                <div class="col-xs-8 wthree_about_right_grid_right">
                    <h4>专业能力</h4>
                    <p>熟练使用 idea、eclipse 等开发工具 熟练使用主流的关系型数据库，如 mysql 熟悉 Html，Css，JavaScript 的基本使用 熟悉 Java 基本语法，熟练掌握 SpringMVC，SpringBoot 框架的基本使用 熟练 Javaweb 应用开发</p>
                </div>
                <div class="clearfix"> </div>
            </div>
            <div class="col-md-6 wthree_about_right_grid">
...
<%--            <h4>WHAT I DID</h4>--%>
            <h3> <span>项目经验</span></h3>
            <span class="border one"></span>
        </div>
        <div class="time-main w3l-agile">
            <div class="col-md-6 year-info">
                <ul class="year">
                    <li>2021-05 - 2021-06   </li>
                    <li> 基于中文新闻分词绘制词云图</li>
                    <li>2022-07 - 2022-08    </li>
                    <li>Dblp 文献检索客户端</li>
<%--                    <li>2013</li>--%>
<%--                    <li>2012</li>--%>
                    <div class="clearfix"></div>
            ...
            <ul class="col-md-6 timeline">
                <li>
                    ...
                    <div class="timeline-panel">
                        <div class="timeline-heading">
                            <h4 class="timeline-title">项目描述</h4>
                        </div>
                        <div class="timeline-body">
                            <p>将所有类别的新闻导入数据库中，以树形目录形式展示新闻类别，使用中文分词算 法解析所有新闻正文，并统计每个词语出现的数量，并以词云图的方式展示</p>
                        </div>
                        <div class="timeline-heading">
                            <h4 class="timeline-title">设计技术</h4>
                        </div>
                        <div class="timeline-body">
                            <p>JSP、Mysql、Echarts、MVC 架构、ajax 技术等</p>
                        </div>
                        <div class="timeline-heading">
                            <h4 class="timeline-title">责任描述</h4>
                        </div>
                        <div class="timeline-body">
                            <p>通过 MVC 框架，结合 ajax 技术将数据导入词云，通过 Echarts 显示词云图</p>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="timeline-panel">
                        ...
                        <div class="timeline-body">
                            <p>开发一个 python 客户端，将 Dblp 网站提供的文献资源数据进行汇总，实现客户 端快速查阅文献并在 Endnote 上进行阅读</p>
                        </div>
                        <div class="timeline-heading">
                            <h4 class="timeline-title">设计技术</h4>
                        </div>
                        <div class="timeline-body">
                            <p>BeautifulSoup，python GUI 编程，python Request 等</p>
                        </div>
                        <div class="timeline-heading">
                            <h4 class="timeline-title">责任描述</h4>
                        </div>
                        <div class="timeline-body">
                            <p>负责文献数据爬取，提供后端数据接口，功能整合以及客户端打包</p>
                        </div>
                    </div>
                </li>
        ...
        <div class="sap_tabs">
            <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                <ul class="resp-tabs-list">
                    ...
                    <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>优秀学生二等奖学金</span></li>
                    <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>年度优秀青年志愿者</span></li>
                    <li class="resp-tab-item" aria-controls="tab_item-3" role="tab"><span>全国英语大赛三等奖</span></li>
                </ul>
